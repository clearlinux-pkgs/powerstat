...
Source0  : https://github.com/ColinIanKing/powerstat/archive/V0.03.00/powerstat-0.03.00.tar.gz
...
%prep
%setup -q -n powerstat-0.03.00
cd %{_builddir}/powerstat-0.03.00
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674579407
