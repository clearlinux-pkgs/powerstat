...
Version  : 0.04.02
Release  : 10
URL      : https://github.com/ColinIanKing/powerstat/archive/V0.04.02/powerstat-0.04.02.tar.gz
Source0  : https://github.com/ColinIanKing/powerstat/archive/V0.04.02/powerstat-0.04.02.tar.gz
...
%prep
%setup -q -n powerstat-0.04.02
cd %{_builddir}/powerstat-0.04.02
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705056543
